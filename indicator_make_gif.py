...
best_model_path = study_dir + '/eval_logs/hyperparameter_' + str(param_id) + '/run_' + str(args.run_id) + '/best_model.zip'
...
for run in range(n_evaluations):
    ...
    gif_path = study_dir + '/eval_logs/hyperparameter_' + str(param_id) + '/run_' + str(args.run_id) + '/best_model_run_' + str(run) + '.gif'
